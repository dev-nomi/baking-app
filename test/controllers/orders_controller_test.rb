...
class OrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order" do
    ...
    assert_difference('Order.count') do
      post orders_path, params: { order: { customer_id: @customer.id, address_id: @address.id, credit_card_number: '4444333322221111', expiration_year: '2027', expiration_month: '12', date: Date.today, shipping: 0.0, products_total: 0.0 } }
    end
  ...
  test "should redirect back to checkout if bad credit card number" do
   ...
   # post orders_path, params: { order: { customer_id: @customer.id, address_id: @address.id, credit_card_number: '44332211', expiration_year: '2027', expiration_month: '12', products_total: 0.0, shipping: 0.0, date: Date.today } }
